...
class Redirect
{
    ...
    public static function to(string $url, int $refresh = 0): void
    {
        try {
            ...
            # Виводимо користувачу повідомлення про помилку.
            echo "Виникла помилка: " . htmlspecialchars($e->getMessage());
        } catch (\Exception $e) {
            ...
            echo "Виникла помилка при виконанні перенаправлення. Будь ласка, зверніться до адміністратора.";
        }
    }
}
